...
public class AdminLogin extends JPanel {
	...
	public AdminLogin(JPanel content) {
		...
		label.setIcon(new ImageIcon("images/book-home.png"));
		panel_2.add(label);
		...
		JLabel lblNewLabel = new JLabel("               Library Admins Login              ");
		...
		JLabel lblNewLabel_1 = new JLabel("Library Admins Provide Login Access");
