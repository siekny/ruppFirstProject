...
-- Dumping database structure for ruppproject
CREATE DATABASE IF NOT EXISTS `ruppproject` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `ruppproject`;

-- Dumping structure for table ruppproject.books
...
-- Dumping data for table ruppproject.books: ~2 rows (approximately)
DELETE FROM `books`;
